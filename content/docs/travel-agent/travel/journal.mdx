...
Journal lines can be edited by clicking on the line in the grid. This will open the journal line form, where you can update the traveler's information, such as name, age, and passport details. Check out the [Journal Lines documentation](/content/docs/travel-agent/data-management/package-data/journal-lines.mdx) for more details on how to manage journal lines.
</Step>
</Steps>
