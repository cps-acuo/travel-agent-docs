...
To add a new traveler to the system, click on the **New** button in the command bar. This will open a form where you can enter the traveler's details.

![Creating a new traveler](/images/travel-agent/travel-new-traveler.png)
...
- **Address**: The traveler's mailing address.
