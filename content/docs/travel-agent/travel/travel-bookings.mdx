...
You can also see which travelers are associated with the booking and the payments that have been made or are due for the booking.
...
In the Payments section, you can view all payments made towards the booking. You can view the payment details [here in the payment claims](./payment-claims).
