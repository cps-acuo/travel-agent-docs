...
description: The Travel Packages list is the initial screen displayed upon opening the application. It provides an overview of all travel packages, enabling you to manage, create, and edit packages, as well as configure web booking layouts and view booking information.
icon: TicketsPlane
---
...
![The Travel Packages page in Travel Agent](/images/travel-agent/travel-packages-active-view-2.png)
</Step>
<Step>
...
## Purposed based form for Travel Package :
