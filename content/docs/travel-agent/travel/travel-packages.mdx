...
description: The Travel Packages list is the main screen of the application. View, create, and edit packages, configure web booking layouts, and review booking information.
icon: TicketsPlane
---
