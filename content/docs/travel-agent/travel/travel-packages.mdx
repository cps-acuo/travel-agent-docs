---
title: Packages
description: The Packages list is the main screen of the application. View, create, and edit packages, configure web booking layouts, and review booking information.
icon: TicketsPlane
---
...
## Purposed based form for  Package :
...
- **Package Actions**: Set up actions related to the package, such as flights, hotels, tours, and food & beverage.
    ...
    - **Display on Web**: There are options of displaying Action for select on web bookings and the also if is per traveler or for booking i.e. all travelers.
