...
description: The Travel Packages list is the initial screen displayed upon opening the application. It provides a comprehensive overview of all travel packages, enabling you to manage, create, and edit packages, as well as configure web booking layouts and view booking information.
icon: TicketsPlane
---
