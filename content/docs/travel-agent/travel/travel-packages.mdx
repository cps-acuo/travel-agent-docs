...
<Step>
## Editing a Travel Package and Viewing Related Information using Purpose-Based Forms
![Travel Agent interface showing three purpose-based form options for editing packages: Sales Booking and Web, Package Actions and Availability, and Package Procurement. Each option is presented as a selectable card within the package management interface.](/images/travel-agent/package-sub-form-selection.png)
...
- **Travelers**: Displays all travelers/attendees assigned to the package.
- **Bookings**: Lists all bookings sold for the package.
- **Payments/Claims**: Shows all payments/claims associated with the package.
- **Traveler Actions**: Lists all actions registered for travelers/attendees in the package.
...
The Package tab has the following groups and fields: 
