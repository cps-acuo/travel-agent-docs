...
Payment claims are also generated automatically during the booking process, in accordance with the package's payment setup. However, claims can also be created manually for any booking, provided they are linked to a specific booking record.
