...
1. Navigate to the Payments Imported section
2. Click on **Import Payments**
3. Select the source type (bank statement, payment gateway, etc.)
4. Choose the file format (CSV, Excel, XML, etc.)
5. Upload your payment data file or connect to the API
6. Map the data fields to the system fields
7. Review the preview of the import
