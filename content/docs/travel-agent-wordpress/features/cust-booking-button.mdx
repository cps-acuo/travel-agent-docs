...
The booking button embeds the [booking form](/docs/ta-bookingform) via an iframe, enabling users to complete bookings without leaving your site. It’s fully customizable to ensure seamless brand integration.
