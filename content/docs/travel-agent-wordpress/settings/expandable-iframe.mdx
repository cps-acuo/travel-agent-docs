...
description: "Configure the default appearance and behavior of the booking iframe on your travel package pages using the following settings. These options allow you to tailor the user experience and ensure seamless integration with your site’s design and workflow."
---
...
- **Button Text (Pre-Sale)**
  Sets the text displayed on the booking button for pre-sale packages (e.g., “Register for Pre-Sale”).
- **Close Button Text**  
