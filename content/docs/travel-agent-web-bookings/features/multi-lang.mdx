...
Additional languages will be supported in future releases, guided by user feedback and customer need.

<div className="grid grid-cols-1 md:grid-cols-2 gap-4 justify-center items-center">
  <ImageZoom src={"/images/travel-agent-web-bookings/booking-form-plain.png"} width={1200} height={800} alt='Booking Form Kolumbus'/>
  <ImageZoom src={"/images/travel-agent-web-bookings/booking-form-plain-isl.png"} width={1200} height={800} alt='Booking Form FSEB'/>
</div>
> _Pictured: The Travel Agent booking form in English (left) and Icelandic (right)._

## Supported Locales

- **English** (`en`)
- **Icelandic** (`is`)
> _Note: Language support is expanded as needed._
